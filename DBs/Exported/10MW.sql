...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 19, 2024 at 07:48 AM
...
INSERT INTO `classes` (`id`, `name`, `study_field_id`, `start_date`, `end_date`, `location_id`) VALUES
(1, 'Introduction to Computer Science', 1, '2021-09-01', '2022-12-15', 1),
(2, 'Data Structures and Algorithms', 1, '2022-01-03', '2022-05-13', 1),
(3, 'Introduction to Electrical Engineering', 2, '2021-09-01', '2022-12-15', 2),
(4, 'Circuits and Systems', 2, '2022-01-03', '2022-05-13', 2),
(5, 'Introduction to Mechanical Engineering', 3, '2021-09-01', '2022-12-15', 3),
(6, 'Dynamics and Controls', 3, '2022-01-03', '2022-05-13', 3),
(7, 'Introduction to Mathematics', 4, '2021-09-01', '2022-12-15', 4),
(8, 'Calculus I', 4, '2022-01-03', '2022-05-13', 4),
(9, 'Introduction to Physics', 5, '2021-09-01', '2022-12-15', 5),
(10, 'Classical Mechanics', 5, '2022-01-03', '2022-05-13', 5),
(11, 'Introduction to Programming', 1, '2021-09-01', '2021-12-15', 1),
(12, 'Data Structures and Algorithms', 2, '2021-09-01', '2021-12-15', 2),
(13, 'Software Design Patterns', 3, '2021-09-01', '2021-12-15', 3),
(14, 'Introduction to Programming', 1, '2021-09-01', '2021-12-15', 1),
(15, 'Data Structures and Algorithms', 2, '2021-09-01', '2021-12-15', 2),
(16, 'Software Design Patterns', 3, '2021-09-01', '2021-12-15', 3);
...
(16, 'Telecom SudParis', 'France', 'Évry-Courcouronnes', '9 Rue Charles Fourier');
...
(3, 'Alice', 'Smith', 'alicesmith', '$2y$12$uH/riSDkD4W//mfMP7QF4OoG1BQYZF/.tr20TUN.ECplkJYoil1/O', 'alice.smith@example.com', '', '1992-12-15', '2021-01-03 20:20:20', 'student-1.jpg', 'USA', 'Stanford', 3, 'student'),
...
(12, '', 'Curie', 'mariecurie', '$2y$12$uH/riSDkD4W//mfMP7QF4OoG1BQYZF/.tr20TUN.ECplkJYoil1/O', 'mariecurie@example.com', 'female', '1999-01-01', '2021-09-01 10:00:00', '', 'France', 'Troyes', 2, 'student'),
...
(16, 'Pierre', '', 'pierrehermite', 'password123', 'pierrehermite@example.com', 'male', '2000-01-01', '2021-09-01 10:00:00', '', 'France', 'Évry-Courcouronnes', 3, 'student');
...
INSERT INTO `studyfields` (`id`, `name`, `location_id`) VALUES
